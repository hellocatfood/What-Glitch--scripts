...
echo -e "\033[33mWhat Glitch? bmp/rgb. \033[0m"
...
ffmpeg -i out_%d.bmp -sameq -vcodec huffyuv -r $framerate ../outfile_bmprgb_"$rand".mkv

#remove the temporary directory
cd ../
rm -rf temp_$rand/
echo -e "\033[33mJob done. Check for outfile_bmprgb_"$rand".mkv \033[0m"
