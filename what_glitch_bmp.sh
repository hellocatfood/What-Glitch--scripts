...
echo -e "\033[33mWhat Glitch? bmp. \033[0m"
...
ffmpeg -i out_%d.bmp -sameq -vcodec huffyuv -r $framerate ../outfile_bmp_"$rand".mkv

#remove the temporary directory
cd ../
rm -rf temp_$rand/
echo -e "\033[33mJob done. Check for outfile_bmp_"$rand".mkv \033[0m"
