...
echo -e "\033[33mWhat Glitch? 1bitgif. \033[0m"
...
ffmpeg -i out_%d.gif -sameq -vcodec huffyuv -r $framerate ../outfile_1bitgif_"$rand".mkv

#remove the temporary directory
cd ../
rm -rf temp_$rand/
echo -e "\033[33mJob done. Check for outfile_1bitgif_"$rand".mkv \033[0m"
