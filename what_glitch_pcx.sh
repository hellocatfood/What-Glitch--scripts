...
echo -e "\033[33mWhat Glitch? pcx. \033[0m"
...
ffmpeg -i $file -sameq -r $framerate out_%d.pcx
...
ffmpeg -i out_%d.pcx -sameq -vcodec huffyuv -r $framerate ../outfile_pcx_"$rand".mkv

#remove the temporary directory
cd ../
rm -rf temp_$rand/
echo -e "\033[33mJob done. Check for outfile_pcx_"$rand".mkv \033[0m"
