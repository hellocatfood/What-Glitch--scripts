...
echo -e "\033[33mWhat Glitch? ppm. \033[0m"
...
ffmpeg -i $file -sameq -r $framerate out_%d.ppm
...
ffmpeg -i videoaudio.wav -i out_%d.ppm -sameq -vcodec huffyuv -r $framerate ../outfile_ppm_"$rand".mkv

#remove the temporary directory
cd ../
rm -rf temp_$rand/
echo -e "\033[33mJob done. Check for outfile_ppm_"$rand".mkv \033[0m"
